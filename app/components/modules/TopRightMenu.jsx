...
function TopRightMenu({username, showLogin, logout, loggedIn, showSignUp, userpic, vertical, navigate, toggleOffCanvasMenu, probablyLoggedIn}) {
    ...
    return (
         <ul className={mcn}>
            <li className={lcn}><a href="/trending" >Home</a></li>
            <li className={lcn}><a href="/about.html">About Us</a></li>
            <li className={lcn}><a href="/privacy.html">Privacy Policy</a></li>
            <li className={lcn}><a href="/contact.html">Contact Us</a></li>
            <li className={lcn}><a href="/terms.html">Terms of Service</a></li>
            {!vertical && <li><a href="/static/search.html" title="Search">Search Articles &nbsp; <Icon name="search" /></a></li>}      
        </ul>
