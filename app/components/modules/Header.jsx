...
class Header extends React.Component {
    ...
    render() {
        ...
        if (process.env.BROWSER) document.title = page_title + ' — Steem Crawl';
                ...
                <div className="Header__top header">
                        ...
                        <div className="columns">
                            <ul className="menu">
                                <li>
                                    <Link to={logo_link}>
                                        <img src={require('app/assets/images/steem-crawl-logo3.png')} height="42px" />
                                    </Link>                                    
                                </li>
                        ...
                        <div className="columns shrink ashrink">
                            <TopRightMenu {...this.props} />

                        </div>
                        <div className="columns shrink shrinka">
                        <ul className="menu">
