...
export default class PostFull extends React.Component {
    ...
    fbShare(e) {
        ...
        const q = 'u=' + encodeURIComponent(s.url) + '&source=Steemit&mini=true';
        window.open('https://www.facebook.com/sharer/sharer.php?' + q, 'Share', 'top=' + winTop + ',left=' + winLeft + ',toolbar=0,status=0,width=' + winWidth + ',height=' + winHeight);
    }
    ...
    render() {
        ...
        if (process.env.BROWSER && title) document.title = title + ' — Steem Crawl';
        ...
        this.share_params = {
            url: 'http://steemcrawl.com/' + link,
            title: title + ' — SteeCrawl',
            desc: p.desc
        };
