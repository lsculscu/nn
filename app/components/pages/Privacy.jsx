    ...
    render() {
        return (
            <div className="Privacy row">
                <div className="column large-12 back">
                    <h2 className="above">Steem Crawl, Privacy Policy</h2>
                    <div>
                        <h3 className="above">Effective April 1, 2016</h3>
                        <p>
                            <span className="section">1</span>
                            We want you to understand how and why  Steem Crawl (“Steem Crawl,” “we” or “us”) collects, uses, and shares information about you when
                            you access and use  Steem Crawl’s websites, mobile apps, widgets, and other online products and services (collectively, the "Services")
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            If you purchase products or services from us, we will collect certain information from you, including your name,
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <ul>
                                ...
                                <li>Help protect the safety of  Steem Crawl and our users, which includes blocking suspected spammers, addressing abuse, and
                                    enforcing the  Steem Crawl user agreement and the Terms of Service;
                                </li>
                        ...
                        <div>
                            ...
                            <ul>
                                ...
                                <li>When other users view your profile, they will be able to see information about your activities on the Services, such as your
                                    username, prior posts and comments and how long you have been a member of the Services.
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div>
                        <div>
                            ...
                            <ul>
                                ...
                                <li>We may share information if we believe your actions are inconsistent with our user agreements, or other  Steem Crawl policies, or
                                    to protect the rights, property, and safety of ourselves and others;
                                </li>
                                <li>We may share information between and among  Steem Crawl, and its current and future parents, affiliates, subsidiaries, and other
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            Services, but  Steem Crawl does not link to or provide your actual  Steem Crawl account details to these advertising partners. This means that
                             Steem Crawl does not share your individual account browsing habits with advertisers.  Steem Crawl cannot see advertisers’ cookies and
                            advertisers will not see  Steem Crawl cookies.
                        </p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            for analytics and measurement purposes or to otherwise provide our Services (e.g.,  steemcrawl.com buttons), but we will not load any
                    ...
                    <div>
                        <p>
                            <span className="section">26</span>
                             Steem Crawl complies with the U.S.-E.U. and U.S.-Swiss Safe Harbor Privacy Principles of notice, choice, onward transfer, security, data
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            adding a statement to steem anouncements, the front page of the Services or sending you a notification). We encourage you to review the
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            If you have any questions about this Privacy Policy, please email <a href="mailto:steemcrawl@mail.com">steemcrawl@mail.com</a>.
                        </p>
                    </div>
                </div>
            </div>
